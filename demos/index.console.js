...
(function(wid) {
  ...
  function setKeyAndValue(key, value) {
    ...
    return isCustomerAttr
      ...
      : `<div class='attribute'><strong>${key}</strong>: ${
          isEmptyString ? "''" : value
        },&nbsp;</div>`;
  }
  ...
  const line = function(title, end) {
    ...
    if (typeof title === 'string') {
      infoNodeClassName += isRender
        ? ' page-line-color-green'
        : ' page-line-color-blue';
      titleNode = document.createElement('div');
      titleNode.className =
        'page-line-title' + (isRender ? ' page-line-title-green' : '');
